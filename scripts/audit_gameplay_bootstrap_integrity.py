...
def closures() -> list[dict[str, Any]]:
    data = [
        ("P1-DEP-001", "P1", "FancyNpcs was optional while canonical onboarding required it",
         ...
         ["src/main/resources/paper-plugin.yml", "src/main/resources/class-spec-dependencies.lock.yml",
          "src/main/java/hu/taliann/icesmp/classspec/compat/ClassSpecDependencyPreflight.java",
        ...
        ("P1-QST-001", "P1", "26 COLLECT_ITEMS objectives lacked player-semantic producers",
         ...
         ["src/main/resources/content/progression/quests.yml",
          ...
          "src/main/java/hu/taliann/icesmp/progression/ItemAcquisitionPolicy.java",
          "src/main/java/hu/taliann/icesmp/utils/ItemProvenance.java"]),
        ("P1-SPL-001", "P1", "projectile PDC spell ID never reached SpellSchool/DamageType",
         ...
         ["src/main/resources/content/progression/spells.yml",
          "src/main/java/hu/taliann/icesmp/spells/ProjectileBurstSpell.java",
          ...
          "src/main/java/hu/taliann/icesmp/listeners/SpellProjectileListener.java"]),
        ("P1-EQP-001", "P1", "Kallan/Nap canonical material could not activate ON_SHOOT",
         ...
         ["src/main/resources/content/equipment/equipment.yml",
          ...
          "src/main/java/hu/taliann/icesmp/itemization/SignatureEffectRegistry.java",
        ...
        ("P2-EQP-002", "P2", "template render returned before recipe-owned enchant stamping",
         ...
         ["src/main/resources/config/crafting.yml",
          "src/main/resources/config/professions-2.yml",
          "src/main/resources/content/professions/recipes.yml",
          "src/main/java/hu/taliann/icesmp/itemization/ItemIdentityService.java",
          "src/main/java/hu/taliann/icesmp/items/SignatureEnchantKeys.java"]),
        ("P2-ADV-001", "P2", "two authored toast nodes had no consumer",
         ...
         ["src/main/java/hu/taliann/icesmp/managers/AdvancementService.java",
          "src/main/java/hu/taliann/icesmp/utils/ToastUtil.java",
          "src/main/resources/datapack/data/icesmp/advancement/toast_discovery.json",
          "src/main/resources/datapack/data/icesmp/advancement/toast_milestone.json"]),
        ("P2-UX-001", "P2", "level 50 appeared as two business milestones",
         ...
         ["src/main/resources/datapack/data/icesmp/advancement/class_max.json",
        ...
        ("P3-DEP-001", "P3", "three dependencies were declared without consumers",
         ...
         ["src/main/resources/paper-plugin.yml", "src/main/resources/class-spec-dependencies.lock.yml",
          "docs/ARCHITECTURE.md", "docs/ADMIN_GUIDE.md"]),
        ("P3-LIF-001", "P3", "three static facades retained disabled core graphs",
         ...
         ["src/main/java/hu/taliann/icesmp/managers/ConfigManager.java",
          "src/main/java/hu/taliann/icesmp/managers/AdvancementService.java",
          "src/main/java/hu/taliann/icesmp/itemization/ItemTemplateRegistry.java",
          "src/main/java/hu/taliann/icesmp/core/IceSMPCore.java"]),
        ("P3-DOC-001", "P3", "advancement counts drifted",
         "21 persistent + 1 reusable toast + 22 total documented", ["docs/evidence inventory"],
         ["docs/ARCHITECTURE.md", "docs/FEATURES.md", "docs/QUESTS.md",
          "docs/development/gameplay-bootstrap-integrity-hardening.json"]),
    ]
    return [{"id": fid, "severity": severity, "original_root_cause": root,
            ...
            for fid, severity, root, implementation, tests, files in data]
