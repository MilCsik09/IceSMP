...
public interface WorldWeaverProvider {
    ...
    default RecoveryAssessment assessAreaRecovery(final RecoveryContext context, final SubjectSnapshot snapshot,
        ...
        return new RecoveryAssessment(hu.taliann.icesmp.dev.weaver.persistence.ObservedOperationState.PARTIAL, false, Optional.empty(), "AREA_ASSESSMENT_UNAVAILABLE");
    }
}
