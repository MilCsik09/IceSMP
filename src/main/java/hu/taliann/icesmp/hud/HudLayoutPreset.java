...
public record HudLayoutPreset(String id, String resolution, int guiScale,
    ...
    public static final List<HudLayoutPreset> VALUES = List.of(
            preset("720p-gui2", "1280x720", 2, 0, 18, 18, 2),
            preset("1080p-gui2", "1920x1080", 2, 0, 24, 24, 2),
            preset("2048x1152-gui3", "2048x1152", 3, 0, 24, 24, 2),
            preset("1440p-gui3", "2560x1440", 3, 0, 24, 24, 2),
            preset("4k-gui4", "3840x2160", 4, 0, 28, 28, 2),
            preset("large-accessible", "bármely", 3, 0, 28, 28, 5));
