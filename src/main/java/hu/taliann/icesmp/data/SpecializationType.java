...
public enum SpecializationType {
    ...
    PLAGUEBRINGER("plaguebringer", "<dark_green>Pestishozó</dark_green>", JobType.ASSASSIN, FactionType.DARK, true),
    ...
    BONE_PRIEST("bone_priest", "<gray>Csontpap</gray>", JobType.PRIEST, FactionType.DARK, true),
    ...
    DEMONOLOGIST("demonologist", "<dark_purple>Demonológus</dark_purple>", JobType.WARLOCK, FactionType.DARK, true),
