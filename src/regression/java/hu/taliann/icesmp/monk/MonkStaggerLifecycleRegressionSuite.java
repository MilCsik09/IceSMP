...
public final class MonkStaggerLifecycleRegressionSuite {
    ...
    private static void deathAndSpecSwitchSemanticsAreExplicit() throws Exception {
        ...
        final int quitPay = service.indexOf("applyStaggerConsequence(event.getPlayer().getUniqueId());", quit);
        ...
        final int kickPay = service.indexOf("applyStaggerConsequence(event.getPlayer().getUniqueId());", kick);
        ...
        final int specPay = service.indexOf("applyStaggerConsequence(playerId);", spec);
