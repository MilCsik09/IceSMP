...
def main():
    ...
    out.append('')
    out.append('1. **Egységes felbontás:** minden custom textúra AZONOS méretű — 32×32 (a vanilla 16×16 mellett ez még harmonikus; vegyes felbontás tilos).')
    out.append('2. **Margó:** a tárgy ne érjen a vászon széléig — 32-esnél ~3-4 px üres perem, középre igazítva (a vanilla a vászon ~80%-át tölti ki).')
