...
| `relics/` | 12 (8 + `ability/`) | Relikvia-keret: `RelicRegistry`, `RelicDefinition`, triggerek, immutable világ-pillanatkép + single-writer store. |
| `items/` | 13 | Item-gyárak (katalizátor, befogó item, tervrajz, egyedi alapanyag…). |
