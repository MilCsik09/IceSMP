...
| `gui/` | 48 | Inventory-menük + `GuiUtil` közös helperek + adat-vezérelt `CommandMenu` rendszer + esemény-spawn config-kiterjesztés. |
...
- **Méret:** 576 Java-fájl, ~85 000 sor; 90 `*Manager` osztály (a `managers/` csomag 120 fájl).
