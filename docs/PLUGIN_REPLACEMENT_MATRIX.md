...
| AxAFKZone / AxAPI | nincs termékigény jutalmazó AFK-zónára | globális automatikus/manual AFK, tablista és közös jutalomkapu | éles jar/adat/remap-cache operátori eltávolítása | reward-zóna, payout, bossbar, selection, migráció | **CANCELLED / OUT OF SCOPE** | `afkRegressionTest`, consistency product-boundary; manuális Folia playtest |
