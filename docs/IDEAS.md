...
A tár **336 kidolgozott ötletet** tartalmaz 10 kategória-fájlban (`docs/ideas/`).
...
|---|---|---|---|
| **A) Polish / meglévő átdolgozás** | [ideas/A-polish.md](ideas/A-polish.md) | A1–A62 | GUI/HUD/spell-QoL, kényelmi funkciók, hozzáférhetőség. **A1–A16 ✅ implementálva** (teszt: PLAYTEST.md); A17 = HP-rendszer átdolgozás (tulaj kérése, külön kör) |
