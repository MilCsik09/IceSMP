...
|---|---|---|---|
| **A) Polish / meglévő átdolgozás** | [ideas/A-polish.md](ideas/A-polish.md) | A1–A72 | GUI/HUD/spell-QoL, kényelmi funkciók, hozzáférhetőség. **A1–A16 + A43–A62 + A69–A70 ✅ implementálva** (teszt: PLAYTEST.md); A17 = HP-rendszer átdolgozás (tulaj kérése, külön kör) |
